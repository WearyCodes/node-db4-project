...
const steps = [
  ...
  { step_number: 1, step_text: "Heat pan.", recipe_id: 1 },
  { step_number: 2, step_text: "Add broccoli", recipe_id: 1 },
  {
    step_number: 3,
    step_text: "Add pesto mixed with pasta",
    recipe_id: 1,
  },
  // Lemon Chicken
  { step_number: 1, step_text: "Heat oven", recipe_id: 2 },
  {
    step_number: 2,
  ...
  {
    step_number: 3,
    step_text: "Put in oven at 500 degrees",
    recipe_id: 2,
  },
  // Salmon en Papillote
  {
  ...
  { step_number: 2, step_text: "Cook salmon", recipe_id: 3 },
];
